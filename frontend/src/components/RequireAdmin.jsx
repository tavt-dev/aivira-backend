    ...
    return (
      <div className="grid min-h-screen place-items-center bg-slate-950 px-4 py-12">
        <div className="w-full max-w-md rounded-3xl border border-white/10 bg-white p-8 text-center shadow-2xl">
          <span className="inline-flex rounded-full bg-blue-50 px-3 py-1 text-xs font-bold uppercase tracking-wider text-blue-600">Admin security</span>
          <h1 className="mt-4 font-serif text-3xl font-bold text-slate-950">Checking access</h1>
          <p className="mt-2 text-slate-500">Verifying your Aivira admin role.</p>
        </div>
      </div>
    );
  }
