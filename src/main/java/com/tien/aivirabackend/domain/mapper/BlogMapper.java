...
public class BlogMapper {
    ...
    public BlogPostSummaryResponse toSummaryResponse(BlogPost post) {
        return BlogPostSummaryResponse.builder()
                ...
                .category(toCategoryResponse(post.getCategory()))
    ...
    public BlogPostResponse toResponse(BlogPost post) {
        return BlogPostResponse.builder()
                ...
                .status(post.getStatus())
                .coverUrl(post.getCoverUrl())
                .coverPublicId(post.getCoverPublicId())
                .coverAltText(post.getCoverAltText())
                ...
                .author(toAuthorResponse(post.getCreatedBy()))
                .updatedBy(
                        post.getUpdatedBy() == null ? null : post.getUpdatedBy().getId())
                .publishedAt(post.getPublishedAt())
                ...
                .relatedProducts(post.getRelatedProducts().stream()
                        ...
                        .map(this::toRelatedProductResponse)
                        .toList())
                .assets(post.getAssets().stream()
                        .sorted(Comparator.comparing(BlogAsset::getId))
    ...
    public BlogAssetResponse toAssetResponse(BlogAsset asset) {
        return BlogAssetResponse.builder()
                .id(asset.getId())
                .url(asset.getUrl())
    ...
    private BlogRelatedProductResponse toRelatedProductResponse(Product product) {
        return BlogRelatedProductResponse.builder()
                .id(product.getId())
