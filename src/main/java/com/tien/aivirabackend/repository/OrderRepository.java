...
public interface OrderRepository extends JpaRepository<Order, Long>, JpaSpecificationExecutor<Order> {
    ...
    @Query("""
            ...
            """)
    List<OrderStatusCountProjection> countOrdersByStatusBetween(@Param("fromDate") Instant fromDate,
    ...
    @Query(value = """
            ...
            """, nativeQuery = true)
    List<DailyOrderCountProjection> countDailyOrdersBetween(@Param("fromDate") Instant fromDate,
            @Param("toDate") Instant toDate);
    ...
    @Query("""
            ...
            """)
    List<TopBookProjection> findTopBooksBetween(@Param("excludedStatuses") Collection<OrderStatus> excludedStatuses,
