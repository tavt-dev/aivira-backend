...
@Configuration
@OpenAPIDefinition(info = @Info(title = "Aivira Backend API", version = "0.0.1-SNAPSHOT", description = """
        ...
        """, contact = @Contact(name = "Aivira Store")), servers = @Server(url = "/api/v1", description = "Local API base path"))
