...
public enum FileValidationErrorCode implements ErrorCode {
    ...
    INVALID_FILE_SIGNATURE("INVALID_FILE_SIGNATURE", "Nội dung tệp không khớp với loại đã khai báo.", HttpStatus.UNSUPPORTED_MEDIA_TYPE),
    UNSUPPORTED_MEDIA_CATEGORY("UNSUPPORTED_MEDIA_CATEGORY", "Loại media yêu cầu hiện không được hỗ trợ.", HttpStatus.BAD_REQUEST),
