...
public enum AiAdviceErrorCode implements ErrorCode {
    ...
    MONTHLY_LIMIT_REACHED("E9003", "Bạn đã sử dụng hết 30 lượt tư vấn AI trong tháng này.", HttpStatus.TOO_MANY_REQUESTS),
    REQUEST_IN_PROGRESS("E9004", "Yêu cầu này đang được xử lý.", HttpStatus.CONFLICT),
    AI_ADVISOR_UNAVAILABLE("E9005", "Tư vấn AI hiện tạm thời không khả dụng. Vui lòng thử lại.", HttpStatus.SERVICE_UNAVAILABLE),
