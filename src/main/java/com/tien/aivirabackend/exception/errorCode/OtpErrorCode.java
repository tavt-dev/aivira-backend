...
public enum OtpErrorCode implements ErrorCode {
    ...
    OTP_ALREADY_USED("E5003", "Mã OTP đã được sử dụng.", HttpStatus.BAD_REQUEST), OTP_REQUEST_TOO_FREQUENT("E5004",
            "Bạn đã yêu cầu mã OTP quá nhiều lần. Vui lòng đợi trước khi thử lại.", HttpStatus.TOO_MANY_REQUESTS);
