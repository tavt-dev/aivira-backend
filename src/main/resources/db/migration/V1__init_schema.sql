...
INSERT INTO permissions (code, name, description, permission_group, is_system, created_at, updated_at) VALUES
    ...
    ('SELLER_APPLY', 'Seller apply', 'System permission SELLER_APPLY', 'SHOP', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('SHOP_READ_SELF', 'Shop read self', 'System permission SHOP_READ_SELF', 'SHOP', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('SHOP_UPDATE_SELF', 'Shop update self', 'System permission SHOP_UPDATE_SELF', 'SHOP', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('SHOP_READ_ALL', 'Shop read all', 'System permission SHOP_READ_ALL', 'SHOP', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('SHOP_APPROVE', 'Shop approve', 'System permission SHOP_APPROVE', 'SHOP', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('SHOP_REJECT', 'Shop reject', 'System permission SHOP_REJECT', 'SHOP', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('SHOP_LOCK', 'Shop lock', 'System permission SHOP_LOCK', 'SHOP', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('SHOP_UNLOCK', 'Shop unlock', 'System permission SHOP_UNLOCK', 'SHOP', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('SHOP_MANAGE_ALL', 'Shop manage all', 'System permission SHOP_MANAGE_ALL', 'SHOP', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ...
    ('PRODUCT_CREATE_OWN_SHOP', 'Product create own shop', 'System permission PRODUCT_CREATE_OWN_SHOP', 'PRODUCT', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('PRODUCT_UPDATE_OWN_SHOP', 'Product update own shop', 'System permission PRODUCT_UPDATE_OWN_SHOP', 'PRODUCT', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('PRODUCT_DELETE_OWN_SHOP', 'Product delete own shop', 'System permission PRODUCT_DELETE_OWN_SHOP', 'PRODUCT', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('PRODUCT_SUBMIT_REVIEW_OWN_SHOP', 'Product submit review own shop', 'System permission PRODUCT_SUBMIT_REVIEW_OWN_SHOP', 'PRODUCT', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('PRODUCT_APPROVE', 'Product approve', 'System permission PRODUCT_APPROVE', 'PRODUCT', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('PRODUCT_REJECT', 'Product reject', 'System permission PRODUCT_REJECT', 'PRODUCT', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ...
    ('PRODUCT_MEDIA_UPLOAD_OWN_SHOP', 'Product media upload own shop', 'System permission PRODUCT_MEDIA_UPLOAD_OWN_SHOP', 'PRODUCT', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('PRODUCT_MEDIA_UPDATE_OWN_SHOP', 'Product media update own shop', 'System permission PRODUCT_MEDIA_UPDATE_OWN_SHOP', 'PRODUCT', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('PRODUCT_MEDIA_DELETE_OWN_SHOP', 'Product media delete own shop', 'System permission PRODUCT_MEDIA_DELETE_OWN_SHOP', 'PRODUCT', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ...
    ('INVENTORY_READ_OWN_SHOP', 'Inventory read own shop', 'System permission INVENTORY_READ_OWN_SHOP', 'INVENTORY', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('INVENTORY_UPDATE_OWN_SHOP', 'Inventory update own shop', 'System permission INVENTORY_UPDATE_OWN_SHOP', 'INVENTORY', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('INVENTORY_ADJUST_OWN_SHOP', 'Inventory adjust own shop', 'System permission INVENTORY_ADJUST_OWN_SHOP', 'INVENTORY', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ...
    ('ORDER_READ_OWN_SHOP', 'Order read own shop', 'System permission ORDER_READ_OWN_SHOP', 'ORDER', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('ORDER_CONFIRM_OWN_SHOP', 'Order confirm own shop', 'System permission ORDER_CONFIRM_OWN_SHOP', 'ORDER', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('ORDER_UPDATE_STATUS_OWN_SHOP', 'Order update status own shop', 'System permission ORDER_UPDATE_STATUS_OWN_SHOP', 'ORDER', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ...
    ('REFUND_READ_OWN_SHOP', 'Refund read own shop', 'System permission REFUND_READ_OWN_SHOP', 'REFUND', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('REFUND_APPROVE_OWN_SHOP', 'Refund approve own shop', 'System permission REFUND_APPROVE_OWN_SHOP', 'REFUND', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('REFUND_REJECT_OWN_SHOP', 'Refund reject own shop', 'System permission REFUND_REJECT_OWN_SHOP', 'REFUND', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ...
    ('SHIPPING_READ_OWN_SHOP', 'Shipping read own shop', 'System permission SHIPPING_READ_OWN_SHOP', 'SHIPPING', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('SHIPPING_UPDATE_OWN_SHOP', 'Shipping update own shop', 'System permission SHIPPING_UPDATE_OWN_SHOP', 'SHIPPING', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ...
    ('COUPON_CREATE_OWN_SHOP', 'Coupon create own shop', 'System permission COUPON_CREATE_OWN_SHOP', 'COUPON', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('COUPON_UPDATE_OWN_SHOP', 'Coupon update own shop', 'System permission COUPON_UPDATE_OWN_SHOP', 'COUPON', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('COUPON_DELETE_OWN_SHOP', 'Coupon delete own shop', 'System permission COUPON_DELETE_OWN_SHOP', 'COUPON', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ...
    ('PROMOTION_CREATE_OWN_SHOP', 'Promotion create own shop', 'System permission PROMOTION_CREATE_OWN_SHOP', 'PROMOTION', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('PROMOTION_UPDATE_OWN_SHOP', 'Promotion update own shop', 'System permission PROMOTION_UPDATE_OWN_SHOP', 'PROMOTION', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('PROMOTION_DELETE_OWN_SHOP', 'Promotion delete own shop', 'System permission PROMOTION_DELETE_OWN_SHOP', 'PROMOTION', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ...
    ('REVIEW_REPLY_OWN_SHOP', 'Review reply own shop', 'System permission REVIEW_REPLY_OWN_SHOP', 'REVIEW', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ...
    ('QUESTION_REPLY_OWN_SHOP', 'Question reply own shop', 'System permission QUESTION_REPLY_OWN_SHOP', 'QUESTION', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ...
    ('SUPPORT_TICKET_READ_OWN_SHOP', 'Support ticket read own shop', 'System permission SUPPORT_TICKET_READ_OWN_SHOP', 'SUPPORT', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ('SUPPORT_TICKET_REPLY_OWN_SHOP', 'Support ticket reply own shop', 'System permission SUPPORT_TICKET_REPLY_OWN_SHOP', 'SUPPORT', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ...
    ('DASHBOARD_READ_SELLER', 'Dashboard read seller', 'System permission DASHBOARD_READ_SELLER', 'REPORT', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
    ...
    ('REPORT_READ_OWN_SHOP', 'Report read own shop', 'System permission REPORT_READ_OWN_SHOP', 'REPORT', b'1', CURRENT_TIMESTAMP(6), CURRENT_TIMESTAMP(6)),
...
JOIN permissions p ON p.code IN (
    ...
    'PAYMENT_RETRY_SELF', 'REFUND_CREATE_SELF', 'REFUND_READ_SELF', 'REVIEW_CREATE_SELF',
    'REVIEW_UPDATE_SELF', 'REVIEW_DELETE_SELF', 'QUESTION_CREATE_SELF', 'SUPPORT_TICKET_CREATE_SELF',
    'SUPPORT_TICKET_READ_SELF', 'SELLER_APPLY', 'SHOP_READ_SELF', 'SHOP_UPDATE_SELF',
    'PRODUCT_CREATE_OWN_SHOP', 'PRODUCT_UPDATE_OWN_SHOP', 'PRODUCT_DELETE_OWN_SHOP',
    'PRODUCT_SUBMIT_REVIEW_OWN_SHOP', 'PRODUCT_MEDIA_UPLOAD_OWN_SHOP', 'PRODUCT_MEDIA_UPDATE_OWN_SHOP',
    'PRODUCT_MEDIA_DELETE_OWN_SHOP', 'INVENTORY_READ_OWN_SHOP', 'INVENTORY_UPDATE_OWN_SHOP',
    'INVENTORY_ADJUST_OWN_SHOP', 'ORDER_READ_OWN_SHOP', 'ORDER_CONFIRM_OWN_SHOP',
    'ORDER_UPDATE_STATUS_OWN_SHOP', 'REFUND_READ_OWN_SHOP', 'REFUND_APPROVE_OWN_SHOP',
    'REFUND_REJECT_OWN_SHOP', 'SHIPPING_READ_OWN_SHOP', 'SHIPPING_UPDATE_OWN_SHOP',
    'COUPON_CREATE_OWN_SHOP', 'COUPON_UPDATE_OWN_SHOP', 'COUPON_DELETE_OWN_SHOP',
    'PROMOTION_CREATE_OWN_SHOP', 'PROMOTION_UPDATE_OWN_SHOP', 'PROMOTION_DELETE_OWN_SHOP',
    'REVIEW_REPLY_OWN_SHOP', 'QUESTION_REPLY_OWN_SHOP', 'DASHBOARD_READ_SELLER',
    'REPORT_READ_OWN_SHOP'
)
WHERE r.code = 'SELLER';
