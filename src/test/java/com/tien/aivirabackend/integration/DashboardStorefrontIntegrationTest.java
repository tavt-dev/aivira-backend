...
class DashboardStorefrontIntegrationTest extends AbstractIntegrationTest {
    ...
    void storefrontAndDashboard_shouldUseExistingCommerceData() throws Exception {
        ...
        mockMvc.perform(get("/admin/dashboard/summary")
                        ...
                        .param("fromDate", "2020-01-01T00:00:00Z")
                        .param("toDate", "2030-01-01T00:00:00Z"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data.revenue").value(200.00))
