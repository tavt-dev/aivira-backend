...
class DiscountServiceImplTest {
    ...
    void calculate_shouldApplyBestPromotionThenCoupon() {
        ...
        DiscountCalculation calculation =
                discountService.calculate(user, List.of(cartItem), Map.of(30L, variation), " save10 ");
    ...
    private Coupon coupon(String code, CouponType type, String value, String maxDiscountAmount) {
        ...
        return Coupon.builder()
                ...
                .type(type)
                .value(new BigDecimal(value))
                .maxDiscountAmount(maxDiscountAmount == null ? null : new BigDecimal(maxDiscountAmount))
                .usedCount(0)
                .startAt(now.minusDays(1))
                .endAt(now.plusDays(1))
                .active(true)
